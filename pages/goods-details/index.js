      ...
      success: function(res) {
        ...
        for(var i=0;i<goodsDetailList.goodsDetailList.data.length;i++){
        	...
        	if(e.id==goodsDetailTmp.basicInfo.id){
		        ...
		        that.setData({
		          goodsDetail:goodsDetailTmp,
		          selectSizePrice:goodsDetailTmp.basicInfo.minPrice,
		          buyNumMax:goodsDetailTmp.basicInfo.stores,
		          buyNumber:(goodsDetailTmp.basicInfo.stores>0) ? 1: 0
		        });
